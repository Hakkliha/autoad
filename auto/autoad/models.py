...
class Vehicle(models.Model):
    ...
    body_type = models.CharField(
        max_length=60, blank=True, choices=BODY_TYPE_CHOICES)
    power_kw = models.PositiveIntegerField(blank=True, default=1, null=True)
    displacement_cm = models.PositiveIntegerField(
    ...
    transmission = models.CharField(
        max_length=60, blank=True, choices=TRANSMISSION_TYPE)
    drive = models.CharField(max_length=60, blank=True, choices=DRIVE_TYPE)
    doors = models.PositiveIntegerField(validators=[MinValueValidator(
        0), MaxValueValidator(10)], blank=True, default=2, null=True)
    seats = models.PositiveIntegerField(validators=[MinValueValidator(
        0), MaxValueValidator(10)], blank=True, default=4, null=True)
    equipment = models.TextField(blank=True, null=True)
    steeringwheel = models.CharField(
        max_length=10, blank=True, choices=STEERINGWHEEL_POSITION)
    location = models.CharField(max_length=140, blank=True, null=True)
    country_of_origin = models.CharField(
        max_length=140, blank=True, choices=COUNTRY_OF_ORIGIN_LIST)
    ...
    nr_owner = models.PositiveIntegerField(validators=[MinValueValidator(
        0), MaxValueValidator(1000)], blank=True, default=2)
    ...
    optical_condition = models.CharField(
        max_length=1400, blank=True, choices=O_CONDITION_LIST)
    technical_condition = models.CharField(
        max_length=1400, blank=True, choices=T_CONDITION_LIST)
    interior_condition = models.CharField(
        max_length=1400, blank=True, choices=I_CONDITION_LIST)
